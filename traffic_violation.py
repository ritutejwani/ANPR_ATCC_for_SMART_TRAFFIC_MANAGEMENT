...
class LineDetector:
    def _init_(self, num_frames_avg=10):
...
def main(video_path):
    ...
    while vid.isOpened():
        ...
        for license_plate_image in license_plate_images:
            ...
            if text and text not in penalized_texts:
                ...
                update_database_with_violation(text, dbconnection)
    ...
    print_all_violations(dbconnection)
